...
- [ ] supports Python 2.6 or greater and Python 3.5 or greater / if does not, unsupported [Python versions](https://docs.ansible.com/ansible/latest/dev_guide/developing_python_3.html#ansible-and-python-3) are documented in ``README.md`` and in every module and plugin (or in doc fragments)
